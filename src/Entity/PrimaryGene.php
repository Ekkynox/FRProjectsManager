...
use App\Repository\PrimaryGeneRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PrimaryGeneRepository::class)]
class PrimaryGene extends Gene
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'primaryGene', targetEntity: DragonProject::class)]
    ...
    public function addDragonProject(DragonProject $dragonProject): self
    {
        if (!$this->dragonProjects->contains($dragonProject)) {
            ...
            $dragonProject->setPrimaryGene($this);
        }
    ...
    public function removeDragonProject(DragonProject $dragonProject): self
    {
        if ($this->dragonProjects->removeElement($dragonProject)) {
            ...
            if ($dragonProject->getPrimaryGene() === $this) {
                $dragonProject->setPrimaryGene(null);
            }
        }
